...
import type { PumpFun } from "./idl/index";
...
export class PumpFunSDK {
  ...
  async getBuyInstructions(
    ...
    // console.log(bondingCurveAccount?.creator.toBase58())
    ...
    return [
      ...
      await this.program.methods
        ...
        .accountsPartial({
          ...
          user: buyer,
          creatorVault: this.getCreatorVaultPda(this.program.programId, creator)
    ...
    ixs.push(
      await this.program.methods
        ...
        .accountsPartial({
          ...
          associatedUser: associatedUser,
          user: buyer,
          creatorVault: this.getCreatorVaultPda(this.program.programId, buyer)
        })
        .instruction()
    );
  ...
  async createTokenMetadata(create: CreateTokenMetadata) {
    ...
    console.log("token creatino  --->", request)
    return request.json();
  }
